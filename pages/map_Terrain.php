...
<head>
	...
	<title>Prototype - Habous - Map Terrains</title>
...
<body>
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							...
							<div class="pull-right">
								<div class="btn-group">
									<a href="map_Terrain-full-screen.html" type="button" class="btn btn-default btn-xs">
										mode plein écran
									</a>
								</div>
								<div class="btn-group">
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="editModalLabel">Modifier un terrain</h4>
					</div>
						...
						<div class="row">
							<div class="col-lg-6">
								<form role="form">
									...
									<div class="form-group">
										<label>Symbole</label>
										<input class="form-control" id="Symbole_Edit" type="text">
									</div>
									<div class="form-group">
										<label>Nom du terrain</label>
										<input class="form-control" id="Nom_Edit" type="text">
									</div>
									<div class="form-group">
		...
		<div class="modal fade" id="Add_Modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
						<h4 class="modal-title" id="editModalLabel">Ajouter un terrain</h4>
					</div>
					<div class="modal-body">
						<div class="row">
							<div class="col-lg-6">
								<form role="form">
									...
									<div class="form-group">
										<label>Symbole</label>
										<input class="form-control" id="Symbole_Add" type="text">
									</div>
									<div class="form-group">
										<label>Nom du terrain</label>
										<input class="form-control" id="Nom_Add" type="text">
									</div>
									<div class="form-group">
										<label>Province</label>
		...
		<div class="modal fade" id="Search_Modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
						<h4 class="modal-title" id="myModalLabel">Rechercher un terrain</h4>
					</div>
					<div class="modal-body">
						<div class="row">
							<div class="col-lg-6">
								<form role="form">
									<div class="form-group">
										<label>Identifiant du terrain</label>
										<input class="form-control" id="ID_Search" type="text">
									</div>
									<div class="form-group">
										<label>Symbole</label>
										<input class="form-control" id="Symbole_Search" type="text">
									</div>
									<div class="form-group">
										<label>Nom du terrain</label>
										<input class="form-control" id="Nom_Search" type="text">
									</div>
									<div class="form-group">
										<label>Province</label>
	...
	<script src="../js/Map_Terrain.js"></script>
